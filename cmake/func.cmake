function(install_target)
  ...
  set_target_properties(
    ${INSTALL_TARGET_TRG} PROPERTIES LIBRARY_OUTPUT_DIRECTORY
                                     ${FLUX_ASCEND_PATH}/${INSTALL_TARGET_DST})
...
function(install_file)
  ...
  file(MAKE_DIRECTORY ${FLUX_ASCEND_PATH}/${INSTALL_TARGET_DST})
...
function(add_bin_compile_target)
  cmake_parse_arguments(
    BINCMP
    ""
    "TARGET;OPS_INFO;COMPUTE_UNIT;IMPL_DIR;ADP_DIR;OUT_DIR;INSTALL_DIR;KERNEL_DIR;INCLUDE_PATH"
    ""
    ${ARGN})
  ...
  add_custom_target(${BINCMP_TARGET} COMMAND cp -r ${BINCMP_IMPL_DIR}/*.*
                                             ${BINCMP_OUT_DIR}/src && 
                                             cp -r ${BINCMP_INCLUDE_PATH}/kernel/*.*
                                             ${BINCMP_OUT_DIR}/src)
    ...
    foreach(bin_script ${bin_scripts})
      ...
      add_custom_target(
        ...
        COMMAND
          ...
          ASCEND_CUSTOM_OPP_PATH=${FLUX_ASCEND_PATH}/packages/vendors/${vendor_name}
