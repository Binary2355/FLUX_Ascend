...
static ge::graphStatus TilingFunc(gert::TilingContext* context)
{
    ...
    coreData = GetCeilInt(coreData, 64) * 64; // 64*4=256 bytes
...
static ge::graphStatus TestOpsInferDataType(gert::InferDataTypeContext *context)
{
...
namespace ops {
class TestOps : public OpDef {
public:
    explicit TestOps(const char* name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
        ...
        this->SetInferShape(ge::InferShape)
            .SetInferDataType(ge::TestOpsInferDataType);
