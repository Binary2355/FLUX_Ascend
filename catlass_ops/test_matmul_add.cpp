...
template<
    ...
    class LayoutC
>
void run(at::Tensor left, at::Tensor right, at::Tensor output,int m, int n, int k)
{
...
{
    run<Arch::AtlasA2, layout::RowMajor, layout::RowMajor, layout::RowMajor>(left, right, output, m, n, k);
}
